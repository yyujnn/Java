...
public class Student {
	...
	private int age;          // 나이
	private int scoreJava;    // 자바 점수
	private int scoreWeb;     // 웹 점수
	...
	// 3) 생성자도 결국 메소드이다.
	// 4) 매개변수가 아무것도 없는 생성자 기본 생성자(default constructor)라고 
	//    부르는데 생략 가능하다. 
	//    단, 새로운 나만의 생성자를 만들게 되면 기본 생성자는 덮어 씌워진다. (사라진다)
	...
	// 단축키 x --> Source -> Generate Getters and Setters 옵션
